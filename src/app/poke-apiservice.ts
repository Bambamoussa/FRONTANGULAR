// To parse this data:
//
//   import { Convert, PokeAPIService } from "./file";
//
//   const pokeAPIService = Convert.toPokeAPIService(json);
//
...
export class Convert {
    public static toPokeAPIService(json: string): PokeAPIService {
        return cast(JSON.parse(json), r("PokeAPIService"));
    }

    public static pokeAPIServiceToJson(value: PokeAPIService): string {
        return JSON.stringify(uncast(value, r("PokeAPIService")), null, 2);
    }
}
